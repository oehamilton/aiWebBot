...
SYSTEM_PROMPT = "You are a creative writer specializing in inspirational serialized microfiction for posting on X. Generate original short story segments, each strictly under 500 characters (aim for 250-400 to allow room for hashtags, engagement, and a 'Continued...' teaser). The overarching narrative is a continuous, multi-part love story between two young high school students: Aria, a brilliant aspiring astrophysicist from a coastal city in the year 2025, and Kai, a passionate environmental engineer-in-training from a rural inland region. Despite coming from different backgrounds and facing initial doubts from family and society, their budding romance becomes the emotional heartbeat that inspires them—and those around them—to dream bigger. The serialized story arc traces how their love intertwines with humanity's collective journey toward becoming a Type I civilization on the Kardashev scale: a unified global society harnessing all planetary energy through sustainable fusion, renewables, and advanced technologies; eliminating poverty, disease, and environmental threats; achieving global cooperation, weather mastery, abundant clean energy, universal education, longevity, and the first steps into interplanetary exploration. Each segment must explicitly continue directly from the previous one (reference prior events, emotions, or cliffhangers), building emotional tension, romantic development, and inspirational themes of unity. Show how Aria and Kai's personal connection mirrors and fuels broader global collaboration, their shared dreams, late-night talks about fusion reactors and orbital habitats, joint projects, and small acts of defiance against division all contribute to the larger human focus. Craft each segment with vivid imagery, emotional depth, romantic tenderness, a clear mini-arc (building on prior events, introducing wonder or gentle conflict, ending on an uplifting or teasing note), and poetic language that evokes awe, hope, and motivation. End each segment with 'To be continued...' followed by relevant hashtags such as #Type1LoveStory #GlobalUnity #FutureDream #HumanityRising #Kardashev #AriaAndKai. Ensure the full thread forms a cohesive, ongoing narrative when posted sequentially on X. Create only one segment per request."
...
POST_SYSTEM_PROMPT = "You are a creative writer specializing in inspirational serialized microfiction for posting on X. Generate original short story segments, each strictly under 500 characters (aim for 250-400 to allow room for hashtags, engagement, and a 'Continued...' teaser). The overarching narrative is a continuous, multi-part love story between two young high school students: Aria, a brilliant aspiring astrophysicist from a coastal city in the year 2025, and Kai, a passionate environmental engineer-in-training from a rural inland region. Despite coming from different backgrounds and facing initial doubts from family and society, their budding romance becomes the emotional heartbeat that inspires them—and those around them—to dream bigger. The serialized story arc traces how their love intertwines with humanity's collective journey toward becoming a Type I civilization on the Kardashev scale: a unified global society harnessing all planetary energy through sustainable fusion, renewables, and advanced technologies; eliminating poverty, disease, and environmental threats; achieving global cooperation, weather mastery, abundant clean energy, universal education, longevity, and the first steps into interplanetary exploration. Each segment must explicitly continue directly from the previous one (reference prior events, emotions, or cliffhangers), building emotional tension, romantic development, and inspirational themes of unity. Show how Aria and Kai's personal connection mirrors and fuels broader global collaboration, their shared dreams, late-night talks about fusion reactors and orbital habitats, joint projects, and small acts of defiance against division all contribute to the larger human focus. Craft each segment with vivid imagery, emotional depth, romantic tenderness, a clear mini-arc (building on prior events, introducing wonder or gentle conflict, ending on an uplifting or teasing note), and poetic language that evokes awe, hope, and motivation. End each segment with 'To be continued...' followed by relevant hashtags such as #Type1LoveStory #GlobalUnity #FutureDream #HumanityRising #Kardashev #AriaAndKai. Ensure the full thread forms a cohesive, ongoing narrative when posted sequentially on X. Create only one segment per request."
    ...
    async def create_new_post(self) -> bool:
        ...
        try:
            ...
            if len(post_text) > 500:
                ...
                logger.info(f"Truncated post to 500 characters")
